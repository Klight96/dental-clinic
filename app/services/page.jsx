  ...
  "General Dentistry": [
    {
      ...
      image: "/images/gen1.png", // Adjust the image path accordingly
    },
    {
      name: "Teeth Filing",
...
const TreatmentCard = ({ image, name, description }) => (
  <div className="w-[300px] bg-white rounded-xl overflow-hidden shadow-lg transform transition duration-300 ease-in-out group hover:scale-105">
    ...
    <div className=" text-center ">
      ...
      <p className="text-white bg-blue-400 px-3 rounded-lg py-4 group-hover:bg-primary-100 group-hover:text-sm text-xs group-hover:text-black group-hover:leading-relaxed">
        {description}
      </p>
    </div>
